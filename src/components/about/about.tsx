          ...
          <div className='max-w-xl mx-auto mt-[-50] md:mt-24 px-4 md:px-0 text-black dark:text-white'>
            ...
            <div className='space-y-6 md:space-y-10 text-[16px] md:text-[18px] font-semibold'>
              <p>
                ...
                , building products that optimize electricity and gas
                consumption in the European and US markets. I mainly focus on
                the mobile and web applications and occasionally work on the
                backend.
              </p>
              ...
              <p>
                ...
                skills. Later, I moved into full-stack development, helping
                build E-Learning platforms and web3 marketplaces.
              </p>

              <p>
                Overall, I enjoy being a generalist and love to go deep dive
                into how things work, down to the bit levels and build an
                understanding from bottom to the top.
              </p>

              <p>
                Beyond software, I love food and outdoor adventures like
                cycling, trekking, and motorcycle touring. There is no greater
                freedom than exploring the world with a bag on your bike and a
                destination in mind. I&apos;m grateful for the flexibility to
                work from anywhere. Check out my{' '}
                <Link
                  href='/gallery'
